...
# Form implementation generated from reading ui file 'UI/patientData.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.doubleSpinBox_10 = QtWidgets.QDoubleSpinBox(self.widget)
        ...
        self.doubleSpinBox_11.setMinimum(1.0)
        self.doubleSpinBox_11.setMaximum(2.0)
        ...
        self.doubleSpinBox_12 = QtWidgets.QDoubleSpinBox(self.widget)
        ...
        self.doubleSpinBox_16.setMinimum(1.0)
        self.doubleSpinBox_16.setMaximum(2.0)
        ...
        self.doubleSpinBox_19 = QtWidgets.QDoubleSpinBox(self.widget)
        ...
        self.doubleSpinBox_20 = QtWidgets.QDoubleSpinBox(self.widget)
        self.doubleSpinBox_20.setDecimals(0)
        self.doubleSpinBox_20.setMinimum(0.0)
        self.doubleSpinBox_20.setMaximum(1000.0)
        ...
        self.doubleSpinBox_21 = QtWidgets.QDoubleSpinBox(self.widget)
        self.doubleSpinBox_21.setDecimals(0)
        self.doubleSpinBox_21.setMinimum(1.0)
        self.doubleSpinBox_21.setMaximum(2.0)
        ...
        self.doubleSpinBox_22 = QtWidgets.QDoubleSpinBox(self.widget)
        self.doubleSpinBox_22.setDecimals(0)
        self.doubleSpinBox_22.setMinimum(0.0)
        self.doubleSpinBox_22.setMaximum(1000.0)
        ...
        self.doubleSpinBox_23 = QtWidgets.QDoubleSpinBox(self.widget)
        self.doubleSpinBox_23.setDecimals(0)
        self.doubleSpinBox_23.setMinimum(0.0)
        self.doubleSpinBox_23.setMaximum(1000.0)
        ...
        self.doubleSpinBox_24 = QtWidgets.QDoubleSpinBox(self.widget)
        self.doubleSpinBox_24.setDecimals(0)
        self.doubleSpinBox_24.setMinimum(0.0)
        self.doubleSpinBox_24.setMaximum(1000.0)
        ...
        self.doubleSpinBox_25 = QtWidgets.QDoubleSpinBox(self.widget)
        self.doubleSpinBox_25.setDecimals(0)
        self.doubleSpinBox_25.setMinimum(0.0)
        self.doubleSpinBox_25.setMaximum(1000.0)
        ...
        self.doubleSpinBox_26 = QtWidgets.QDoubleSpinBox(self.widget)
        self.doubleSpinBox_26.setDecimals(0)
        self.doubleSpinBox_26.setMinimum(1.0)
        self.doubleSpinBox_26.setMaximum(2.0)
        ...
        self.doubleSpinBox_27 = QtWidgets.QDoubleSpinBox(self.widget)
        self.doubleSpinBox_27.setDecimals(0)
        self.doubleSpinBox_27.setMinimum(0.0)
        self.doubleSpinBox_27.setMaximum(1000.0)
        ...
        self.doubleSpinBox_28 = QtWidgets.QDoubleSpinBox(self.widget)
        self.doubleSpinBox_28.setDecimals(0)
        self.doubleSpinBox_28.setMinimum(0.0)
        self.doubleSpinBox_28.setMaximum(1000.0)
        ...
        self.doubleSpinBox_29 = QtWidgets.QDoubleSpinBox(self.widget)
        self.doubleSpinBox_29.setDecimals(0)
        self.doubleSpinBox_29.setMinimum(0.0)
        self.doubleSpinBox_29.setMaximum(1000.0)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "SEX"))
        self.label_2.setText(_translate("Dialog", "AGE13"))
        self.label_3.setText(_translate("Dialog", "EDUCATION"))
        self.label_4.setText(_translate("Dialog", "MARTIAL"))
        self.label_5.setText(_translate("Dialog", "PROF29"))
        self.label_7.setText(_translate("Dialog", "EXPOSURE"))
        self.label_8.setText(_translate("Dialog", "ANGINA"))
        self.label_9.setText(_translate("Dialog", "STROKE"))
        self.label_10.setText(_translate("Dialog", "HYPERTENSION"))
        self.label_6.setText(_translate("Dialog", "COPD"))
        self.label_11.setText(_translate("Dialog", "TUBERCULOSIS"))
        self.label_12.setText(_translate("Dialog", "CIRRHOSIS"))
        self.label_13.setText(_translate("Dialog", "CHOLECYSTITIS"))
        self.label_14.setText(_translate("Dialog", "ULCER"))
        self.label_15.setText(_translate("Dialog", "POLYPUS"))
        self.label_16.setText(_translate("Dialog", "DIABETES"))
        self.label_17.setText(_translate("Dialog", "DEPRESSION"))
        self.label_18.setText(_translate("Dialog", "MEDICATION"))
        self.label_19.setText(_translate("Dialog", "SIGDAY"))
        self.label_20.setText(_translate("Dialog", "YEARS"))
        self.label_21.setText(_translate("Dialog", "PASSIVE"))
        self.label_22.setText(_translate("Dialog", "ALCOHOL"))
        self.label_23.setText(_translate("Dialog", "FREQ51"))
        self.label_24.setText(_translate("Dialog", "SBP1"))
        self.label_25.setText(_translate("Dialog", "DBP1"))
        self.label_26.setText(_translate("Dialog", "HEIGHT"))
        self.label_27.setText(_translate("Dialog", "WEIGHT"))
        self.label_28.setText(_translate("Dialog", "WAIST"))
        self.label_29.setText(_translate("Dialog", "THIGH"))
